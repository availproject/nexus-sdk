...
export const CHAIN_METADATA: Record<number, ChainMetadata> = {
  ...
  [SUPPORTED_CHAINS.ETHEREUM]: {
    ...
    name: 'Ethereum',
    shortName: 'eth',
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/ethereum/logo.png`,
  ...
  [SUPPORTED_CHAINS.CITREA]: {
    ...
    name: 'Citrea Mainnet',
    shortName: 'citrea',
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/citrea/logo.png`,
  ...
  [SUPPORTED_CHAINS.MONAD]: {
    ...
    name: 'Monad',
    shortName: 'monad',
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/monad/logo.png`,
  ...
  [SUPPORTED_CHAINS.BASE]: {
    ...
    name: 'Base',
    shortName: 'base',
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/base/logo.png`,
    nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
  ...
  [SUPPORTED_CHAINS.ARBITRUM]: {
    ...
    name: 'Arbitrum One',
    shortName: 'arb1',
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/arbitrum/logo.png`,
    nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
    rpcUrls: [
  ...
  [SUPPORTED_CHAINS.OPTIMISM]: {
    ...
    name: 'Optimism',
    shortName: 'oeth',
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/optimism/logo.png`,
    nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
  ...
  [SUPPORTED_CHAINS.POLYGON]: {
    ...
    name: 'Polygon',
    shortName: 'matic',
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/polygon/logo.png`,
  ...
  [SUPPORTED_CHAINS.AVALANCHE]: {
    ...
    name: 'Avalanche',
    shortName: 'avax',
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/avalanche/logo.png`,
  ...
  [SUPPORTED_CHAINS.SCROLL]: {
    ...
    name: 'Scroll',
    shortName: 'scroll',
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/scroll/logo.png`,
    nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
  ...
  [SUPPORTED_CHAINS.KAIA]: {
    ...
    name: 'Kaia Mainnet',
    shortName: 'kaia',
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/kaia/logo.png`,
  ...
  [SUPPORTED_CHAINS.BNB]: {
    ...
    shortName: 'bnb',
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/bnb/logo.png`,
  ...
  [SUPPORTED_CHAINS.HYPEREVM]: {
    ...
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/hyperevm/logo.png`,
  ...
  [SUPPORTED_CHAINS.MEGAETH]: {
    ...
    name: 'MegaETH',
    shortName: 'megaETH',
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/megaeth/logo.png`,
    nativeCurrency: {
      decimals: 18,
      name: 'Ether',
      symbol: 'ETH',
  ...
  [SUPPORTED_CHAINS.SEPOLIA]: {
    ...
    name: 'Sepolia',
    shortName: 'sepolia',
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/ethereum-sepolia/logo.png`,
  ...
  [SUPPORTED_CHAINS.CITREA_TESTNET]: {
    ...
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/citrea-testnet/logo.png`,
    nativeCurrency: {
      decimals: 18,
      name: 'CBTC',
      symbol: 'cBTC',
  ...
  [SUPPORTED_CHAINS.BASE_SEPOLIA]: {
    ...
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/base-sepolia/logo.png`,
    nativeCurrency: { name: 'Sepolia Ether', symbol: 'ETH', decimals: 18 },
  ...
  [SUPPORTED_CHAINS.MONAD_TESTNET]: {
    ...
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/monad-testnet/logo.png`,
  ...
  [SUPPORTED_CHAINS.ARBITRUM_SEPOLIA]: {
    ...
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/arbitrum-sepolia/logo.png`,
    nativeCurrency: { name: 'Sepolia Ether', symbol: 'ETH', decimals: 18 },
  ...
  [SUPPORTED_CHAINS.OPTIMISM_SEPOLIA]: {
    ...
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/optimism-sepolia/logo.png`,
    nativeCurrency: { name: 'Sepolia Ether', symbol: 'ETH', decimals: 18 },
  ...
  [SUPPORTED_CHAINS.POLYGON_AMOY]: {
    ...
    name: 'Polygon Amoy',
    shortName: 'amoy',
    logo: `${NEXUS_CHAIN_ASSETS_BASE_URL}/polygon-amoy/logo.png`,
    nativeCurrency: { name: 'MATIC', symbol: 'MATIC', decimals: 18 },
...
export const NEXUS_EVENTS = {
  ...
  SWAP_STEPS_LIST: 'SWAP_STEPS_LIST',
} as const;
...
export const TOKEN_CONTRACT_ADDRESSES = {
  ...
  USDT: {
    ...
    [SUPPORTED_CHAINS.MEGAETH]: '0xB8CE59FC3717ada4C02eaDF9682A9e934F625ebb',
