...
/**
 * Track general errors occurring in the SDK
 * @param name - Context of the error
 * @param error - Error object captured
 */
export function trackError(name: string, error: Error) {
  trackEvent(`nexus-error`, {
    name,
